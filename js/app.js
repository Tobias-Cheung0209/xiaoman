...
const App = (function () {
  ...
  function renderTravelOverview(tab) {
    ...
    const maps = `<div class="travel-maps">${imageMap('中国','images/china-map.png?v=53',chinaBox,chinaPins)}${imageMap('世界','images/world-map.png?v=53',worldBox,worldPins)}</div>`;
